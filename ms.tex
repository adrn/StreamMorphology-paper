...
On the largest scales ($\gtrsim$30~kpc for a Milky-Way-like galaxy) in the halos of galaxies, the gravitational potentials are thought to be triaxial. However, despite suggestive evidence, this fundamental prediction from LCDM has not been conclusively confirmed from observations. Around other galaxies, it is generally hard to measure the 3D shape of [..] because they are seen in projection. From our position within the Milky Way, our 3D view of our own halo and proximity gives us a unique chance to directly measure the 6D positions of stars and model the shape of the mass distribution at large radii. Unfortunately, the halo also has a low density of tracers. Luckily, however, many of the halo stars are likely associated with debris stripped from in-falling satellite galaxies.
