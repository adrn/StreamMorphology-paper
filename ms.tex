...
\chchchanges{However, the Milky Way's dark matter halo is expected not to be fully integrable; an appreciable fraction of orbits will be chaotic.}
This paper examines the influence of chaos on the phase-space morphology of cold tidal streams.
\chchchanges{Streams in chaotic regions look very different from those in regular regions.}
\chchchanges{We find that streams can be sensitive to chaos on a much shorter time-scale than any standard prediction (from the Lyapunov or frequency-diffusion times).}
...
\centering
    \subfloat{
      \includegraphics[width=0.45\textwidth]{figures/potential.pdf}
    }
    \subfloat{
      \includegraphics[width=0.45\textwidth]{figures/density-contours.pdf}
    }
