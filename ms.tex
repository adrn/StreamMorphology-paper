...
We find that streams (simulated using test particle ensembles of nearby orbits) can be sensitive to chaos on a much shorter time-scale than any standard prediction (from the Lyapunov or frequency-diffusion times).
...
APW is supported by a National Science Foundation Graduate Research Fellowship under Grant No.\ DGE 11-44155. This work was partially supported by the National Science Foundation under Grant No. AST-1312196. MV is supported in part by the University of MichiganÕs Elizabeth Crosby Fund 
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{figures/log-freqmap.pdf}
...
%\begin{figure*}[p]
%\begin{center}
%\includegraphics[width=0.9\textwidth, trim={0 1cm 0 0}]{figures/ic-map.pdf}
...
%\begin{figure*}[p]
%\begin{center}
%\includegraphics[width=\textwidth]{figures/ic-orbits-T.pdf}
...
\centering
    \subfloat{
      \includegraphics[width=0.45\textwidth]{figures/pericenter-map.pdf}
    }
    \subfloat{
      \includegraphics[width=0.45\textwidth]{figures/apocenter-map.pdf}
    }
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.9\textwidth, trim={0 1cm 0 0}]{figures/lyap_map.pdf}
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.9\textwidth, trim={0 1cm 0 0}]{figures/fdiff_map.pdf}
...
%\begin{figure}[p]
%\begin{center}
%\includegraphics[width=\textwidth]{figures/ensemble-density.pdf}
...
%\begin{figure}[p]
%\begin{center}
%\includegraphics[width=0.9\textwidth]{figures/fdiff_zooms.pdf}
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=\textwidth]{figures/ensemble-freqs-0.pdf}
...
%\begin{figure}[p]
%\begin{center}
%\includegraphics[width=\textwidth]{figures/ensemble-freq-evolution-regular.pdf}
...
%\begin{figure}[p]
%\begin{center}
%\includegraphics[width=\textwidth]{figures/ensemble-freq-evolution-mildly_chaotic.pdf}
...
%\begin{figure}[p]
%\begin{center}
%\includegraphics[width=\textwidth]{figures/ensemble-freq-evolution-chaotic.pdf}
