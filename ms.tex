...
Galactic gravitational potentials will almost certainly not be globally integrable, especially if the dark matter halos of galaxies are triaxial. If a triaxial (three dof) potential is close to integrable such that the Hamiltonian can be written in terms of a small perturbation, $\epsilon$, away from some integrable Hamiltonian, $H_0$,
\begin{equation}
...
% TODO: below, should I put sarahs paper here even though we didn't say this explicitly?
