...
The simplest and perhaps most well-known method for assessing chaotic motion is to analyze the Lyapunov spectrum or maximum Lyapunov exponent (MLE) of an orbit. Using our definition of $w$ from Equation~\ref{eq:coords}, we can write Hamilton's equations as 
\begin{equation}
